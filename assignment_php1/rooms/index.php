...
?>
<style>
    table {margin: 0 auto; width:1000px; text-align:center}
</style>
<!-- <div class= "container" > -->
<div class= "" >
    ...
    <tbody>
        <?php foreach($result as $u): ?>
            <tr>
                ...
                <td scope="row" ><a href="../hotels/index.php"><?php echo $u['hotel_id'] ?></a></td>
                <td scope="row" ><?php echo $u['price'] ?></td>
                <td scope="row" ><img src="<?php echo $u['image'] ?>" alt="" width="150px"></td>
                <td scope="row" ><?php echo $u['detail'] ?></td>
                <td scope="row"><?php echo $u['status'] ?></td>
                <td>
